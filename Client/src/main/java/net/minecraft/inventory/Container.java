        ...
        if (mode == 5) {
            ...
            if ((i != 1 || this.dragEvent != 2) && i != this.dragEvent) {
                ...
                if (!this.dragSlots.isEmpty()) {
                    ...
                    for (final Slot slot1 : this.dragSlots) {
                        if (slot1 != null && canAddItemToSlot(slot1, inventoryplayer.getItemStack(), true) && slot1.isItemValid(inventoryplayer.getItemStack()) && inventoryplayer.getItemStack().stackSize >= this.dragSlots.size() && this.canDragIntoSlot(slot1)) {
                            ...
                            final int k = slot1.getHasStack() ? slot1.getStack().stackSize : 0;
            ...
            if (slotId == -999) {
                ...
                if (slot6 != null && slot6.canTakeStack(playerIn)) {
                    final ItemStack itemstack8 = this.transferStackInSlot(playerIn, slotId);

                    if (itemstack8 != null) {
                        final Item item = itemstack8.getItem();
                ...
                if (slot7 != null) {
                    ...
                    final ItemStack itemstack10 = inventoryplayer.getItemStack();
                    ...
                    if (itemstack9 == null) {
                        ...
                        if (itemstack10 == null) {
                            final int j2 = clickedButton == 0 ? itemstack9.stackSize : (itemstack9.stackSize + 1) / 2;
                            final ItemStack itemstack12 = slot7.decrStackSize(j2);
                            ...
                            final int l1 = itemstack9.stackSize;
            ...
            if (slot5.canTakeStack(playerIn)) {
                final ItemStack itemstack7 = inventoryplayer.getStackInSlot(clickedButton);
                ...
                if (slot5.getHasStack() && flag) {
                    final ItemStack itemstack11 = slot5.getStack();
            ...
            if (slot4 != null && slot4.getHasStack()) {
                final ItemStack itemstack6 = slot4.getStack().copy();
            ...
            if (slot3 != null && slot3.getHasStack() && slot3.canTakeStack(playerIn)) {
                final ItemStack itemstack5 = slot3.decrStackSize(clickedButton == 0 ? 1 : slot3.getStack().stackSize);
                slot3.onPickupFromSlot(playerIn, itemstack5);
                playerIn.dropPlayerItemWithRandomChoice(itemstack5, true);
            }
        } else if (mode == 6 && slotId >= 0) {
            final Slot slot2 = this.inventorySlots.get(slotId);
            ...
            if (itemstack4 != null && (slot2 == null || !slot2.getHasStack() || !slot2.canTakeStack(playerIn))) {
                final int i1 = clickedButton == 0 ? 0 : this.inventorySlots.size() - 1;
                final int j1 = clickedButton == 0 ? 1 : -1;

                for (int l2 = 0; l2 < 2; ++l2) {
                    for (int i3 = i1; i3 >= 0 && i3 < this.inventorySlots.size() && itemstack4.stackSize < itemstack4.getMaxStackSize(); i3 += j1) {
                        final Slot slot8 = this.inventorySlots.get(i3);
                        ...
                        if (slot8.getHasStack() && canAddItemToSlot(slot8, itemstack4, true) && slot8.canTakeStack(playerIn) && this.canMergeSlot(itemstack4, slot8) && (l2 != 0 || slot8.getStack().stackSize != slot8.getStack().getMaxStackSize())) {
                            final int l = Math.min(itemstack4.getMaxStackSize() - itemstack4.stackSize, slot8.getStack().stackSize);
